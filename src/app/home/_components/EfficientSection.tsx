...
const EfficientSection = () => {
    return (
        <section className='container'>
            <div className="md:w-5/6 mx-auto bg-color-background rounded-xl flex flex-col lg:flex-row overflow-hidden  lg:py-12 lg:ps-10" data-aos="fade-up" >
            ...
            <div className="md:w-5/6 mx-auto flex flex-col lg:flex-row text-white py-7 gap-4" >

                {/* Left Column */}
                <div className="xl:w-3/5 lg:w-3/5 w-full flex flex-col bg-white-10 rounded-xl " data-aos="fade-left" data-aos-delay="50">
                    <div className="flex justify-center h-full">
                        <div className="w-full md:p-8 p-5 flex flex-col gap-4">
                            ...
                            <div className="w-full mt-auto">
                                <Image src={Images.Precision} alt="Precision" className='w-full h-full' />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full shadow-lg rounded-xl bg-white-10 flex flex-col gap-4 " data-aos="fade-right" data-aos-delay="50">
                    ...
                    <div className="mt-auto w-full">
                        <Image src={Images.Tools} alt="Precision" className='w-full h-full' />
                    </div>
                </div>
            </div>
        </section>
